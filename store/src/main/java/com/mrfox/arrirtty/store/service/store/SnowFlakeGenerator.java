...
public class SnowFlakeGenerator {
     ...
     * 可分配的位数
     */
    private final static int REMAIN_BIT_NUM = 16;
    ...
    public static void main(String[] args) {
        SnowFlakeGenerator snowFlakeGenerator =  new SnowFlakeGenerator(1,2,1,12L);
        System.out.println(("" + snowFlakeGenerator.nextId()).length());
    }
